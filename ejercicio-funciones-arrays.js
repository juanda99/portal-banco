...
// obtener jugadores del Arsenal

const arsenalPlayers = players.filter((player) => player.team === 'Arsenal')
//  first_name + lastName  -> fullName
//  identifier x

// Ahora queremos obtener solamente su nombre completo, posición e imagen:

const modArsenalPlayers1 = arsenalPlayers.map((player) => {
...
// de otra forma, devolvemos el return implicitamente, quitando las {} de
// la función y el return. Pero como aparecen las {} del  objeto json,
// tenemos que ponerlo entre  paréntesis para evitar ambigüedades

const modArsenalPlayers2 = arsenalPlayers.map((player) => ({
  fullName: `${player.first_name} ${player.last_name}`,
  position: player.position,
  image: player.image,
}))

// otra forma, obteniendo los datos del objeto player directamente
// de los parámetros.
// es lo que se llama object destructuring
// const obj = { a: 1, b: { c: 2 } };
// const { a } = obj; // a valdría 1
// en nuestro código:

const modArsenalPlayers3 = arsenalPlayers.map(
  ({ first_name, last_name, position, image }) => ({
    fullName: `${first_name} ${last_name}`,
    position, // equivalente a position: position (object shorthand)
    image,
  })
)
